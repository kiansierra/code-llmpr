...
OUTPUT_DATASET_NAME = "generated_and_scored_texts"
...
def main(args) -> None:
    ...
    dataset = load_from_disk(f"{datadir}/{prefix}")
    ...
    dataset.save_to_disk(f"{INPUT_DATA_DIR}/{OUTPUT_DATASET_NAME}/{prefix}")
    artifact = wandb.Artifact(OUTPUT_DATASET_NAME, type="preference_dataset")
